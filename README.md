...
### blackjack
R code for Monte Carlo methods (Chapter 5) with an example of Blackjack game (example 5.1).
...
### gridworld_windy 
R code for Temporal-Difference Learning ,i.e., SARSA, Q-learning, etc (Chapter 6) with an example of Windy Gridworld (example 6.5).
